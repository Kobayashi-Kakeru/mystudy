package com.example.blecentral3;
...
public class showInfo extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editText = (EditText)findViewById(R.id.chara2);
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == writeButton.getId()) {
            ...
            if (value == null){
                Toast.makeText(this ,"put value in edittext" , Toast.LENGTH_SHORT).show();
                finish();
            }
            writeCharacteristic(uuids[key][0], uuids[key][2], value.getBytes());
            return;
        }
